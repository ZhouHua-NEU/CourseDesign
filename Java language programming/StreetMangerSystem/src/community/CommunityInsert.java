...
public class CommunityInsert extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			//定义prepat	
			java.sql.PreparedStatement pstmt = conn.prepareStatement("insert into  community values(?,?,?,?)");
			//执行查询
			...
			request.getRequestDispatcher("right/community/community_add.jsp").forward(request, response);
