 ...
 */
public class StreetDelete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			...
			//定义prepat	
			java.sql.PreparedStatement pstmt = conn.prepareStatement("delete from  street where streetName = ?");
			//执行查询
			...
			request.getRequestDispatcher("right/street/deleteStreet.jsp").forward(request, response);
